...
public class SysUserController {
    ...
    @SaCheckLogin
    public Result<String> generate(@RequestBody PromptDto promptDto){
        return sysUserService.generate(promptDto);
    }
     ...
     */
    @PostMapping("/avatar/generate/save")
    @SaCheckLogin
    public Result<String> saveGeneratedImage(@RequestBody AiImageDto aiImageDto){
        return sysUserService.saveGeneratedImage(aiImageDto);
    }
    ...
    @SaCheckLogin
    @SaCheckRole("admin")
    public Result<UserVODto> getUser(@PathVariable Long userId){
