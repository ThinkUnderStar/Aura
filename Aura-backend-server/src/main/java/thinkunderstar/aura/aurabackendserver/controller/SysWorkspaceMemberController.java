...
public class SysWorkspaceMemberController {
    ...
    @PutMapping("/set-role")
    @SaCheckLogin
    public Result<WorkspaceMemberVODto> setRole(@RequestBody SetRoleDto setRoleDto){
        return sysWorkspaceMemberService.setRole(setRoleDto);
    }
    ...
    @SaCheckLogin
    public Result<WorkspaceMemberVODto> transferOwnership(
            @RequestParam Long workspaceId,
            @RequestParam Long targetUserId
    ){
        return sysWorkspaceMemberService.transferOwnership(workspaceId, targetUserId);
    }
}
