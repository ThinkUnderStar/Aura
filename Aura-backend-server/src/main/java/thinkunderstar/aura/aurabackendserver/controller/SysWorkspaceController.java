...
public class SysWorkspaceController {
    ...
    @SaCheckLogin
    @SaCheckRole("admin")
    public Result<IPage<Workspace>> getAllWorkspaces(
            @RequestParam(defaultValue = "1") Long page,
            @RequestParam(defaultValue = "20") Long size
    ){
        return sysWorkspaceService.getAllWorkspaces(page, size);
    }
    ...
    @GetMapping("/search")
    @SaCheckLogin
    public Result<IPage<WorkspaceVODto>>  searchMyWorkspaces(
            @RequestParam String keyWord,
            @RequestParam(defaultValue = "1") Long page,
            @RequestParam(defaultValue = "20") Long size
    ){
        return sysWorkspaceService.searchMyWorkspaces(keyWord, page, size);
    }
    ...
    @SaCheckLogin
    @SaCheckRole("admin")
    public Result<Page<Workspace>>  searchAllMyWorkspaces(
            @RequestParam String keyWord,
            @RequestParam(defaultValue = "1") Long page,
            @RequestParam(defaultValue = "20") Long size
    ){
        return sysWorkspaceService.searchAllMyWorkspaces(keyWord, page, size);
    }
}
